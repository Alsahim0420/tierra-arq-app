...
class DashboardDataSourceImpl implements DashboardDataSource {
  ...
  DashboardDataSourceImpl({required HttpService httpService})
  ...
  Future<DashboardEntity> getDashboard() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        developer.log(
          '  [Dashboard] Verificando estructura del JSON completo:',
          name: 'DashboardDataSource',
        );
        developer.log(
          '  - Keys en nivel raíz: ${data.keys.toList()}',
          name: 'DashboardDataSource',
        );
        ...
        if (data.containsKey('data') && data['data'] is Map) {
          ...
          developer.log(
            '  [Dashboard] Verificando estructura de dataObj:',
            name: 'DashboardDataSource',
          );
          developer.log(
            '  - Keys disponibles: ${dataObj.keys.toList()}',
            name: 'DashboardDataSource',
          );
          developer.log(
            '  - obras_a_tiempo_lista existe: ${dataObj.containsKey('obras_a_tiempo_lista')}',
            name: 'DashboardDataSource',
          );
          developer.log(
            '  - obras_retrasadas_lista existe: ${dataObj.containsKey('obras_retrasadas_lista')}',
            name: 'DashboardDataSource',
          );
          developer.log(
            '  - obras_adelantadas_lista existe: ${dataObj.containsKey('obras_adelantadas_lista')}',
            name: 'DashboardDataSource',
          );

          // Verificar si las listas están en el nivel raíz en lugar de dentro de data
          if (!dataObj.containsKey('obras_a_tiempo_lista') &&
              data.containsKey('obras_a_tiempo_lista')) {
            developer.log(
              '  [Dashboard] obras_a_tiempo_lista está en el nivel raíz, no en data',
              name: 'DashboardDataSource',
            );
          }
          ...
          if (dataObj.containsKey('obras_a_tiempo_lista')) {
            developer.log(
              '  - obras_a_tiempo_lista tipo: ${dataObj['obras_a_tiempo_lista'].runtimeType}',
              name: 'DashboardDataSource',
            );
            developer.log(
              '  - obras_a_tiempo_lista es List: ${dataObj['obras_a_tiempo_lista'] is List}',
              name: 'DashboardDataSource',
            );
            if (dataObj['obras_a_tiempo_lista'] is List) {
              developer.log(
                '  - obras_a_tiempo_lista length: ${(dataObj['obras_a_tiempo_lista'] as List).length}',
                name: 'DashboardDataSource',
              );
            }
          }
  ...
  DashboardEntity _mapDashboardFromApi(Map<String, dynamic> data) {
    ...
    final obrasPorEstado =
        data['obras_por_estado'] as Map<String, dynamic>? ??
        <String, dynamic>{};
    ...
    final tareasPorEstado =
        data['tareas_por_estado'] as Map<String, dynamic>? ??
        <String, dynamic>{};
    ...
    developer.log(
      'obras_recientes tipo: ${data['obras_recientes']?.runtimeType}',
      name: 'DashboardDataSource',
    );
    developer.log(
      'obras_recientes es null: ${data['obras_recientes'] == null}',
      name: 'DashboardDataSource',
    );
    developer.log(
      'obras_recientes es List: ${data['obras_recientes'] is List}',
      name: 'DashboardDataSource',
    );

    List<ObraEntity> obrasRecientes = [];
    if (data['obras_recientes'] != null && data['obras_recientes'] is List) {
    ...
    double presupuestoEjecutado = (data['presupuesto_ejecutado'] ?? 0.0)
        .toDouble();
    double varianzaPresupuestaria = (data['varianza_presupuestaria'] ?? 0.0)
        .toDouble();
    ...
    double? porcentajeAvancePromedio =
        data['porcentaje_avance_promedio'] != null
    ...
    try {
      developer.log(
        '  [Dashboard] Iniciando mapeo de obras_a_tiempo_lista',
        name: 'DashboardDataSource',
      );
      final tieneObrasATiempo = data.containsKey('obras_a_tiempo_lista');
      final obrasATiempoValue = data['obras_a_tiempo_lista'];
      developer.log(
        '  - data contiene obras_a_tiempo_lista: $tieneObrasATiempo',
        name: 'DashboardDataSource',
      );
      developer.log(
        '  - data[obras_a_tiempo_lista] es null: ${obrasATiempoValue == null}',
        name: 'DashboardDataSource',
      );
      if (tieneObrasATiempo) {
        developer.log(
          '  - data[obras_a_tiempo_lista] tipo: ${obrasATiempoValue.runtimeType}',
          name: 'DashboardDataSource',
        );
        developer.log(
          '  - data[obras_a_tiempo_lista] es List: ${obrasATiempoValue is List}',
          name: 'DashboardDataSource',
        );
      }
      if (obrasATiempoValue != null && obrasATiempoValue is List) {
        ...
        developer.log(
          '  [Dashboard] obras_a_tiempo_lista tiene ${obrasList.length} elementos',
          name: 'DashboardDataSource',
        );
        ...
        obrasATiempoLista = obrasList
            ...
            .map((entry) {
              ...
              if (item is! Map<String, dynamic>) {
                developer.log(
                  '  [Dashboard] Obra $index en obras_a_tiempo_lista no es Map, tipo: ${item.runtimeType}',
                  name: 'DashboardDataSource',
                );
                return null;
              }
              ...
              try {
                ...
                developer.log(
                  '  [Dashboard] Obra $index mapeada exitosamente: ${obra.title}',
                  name: 'DashboardDataSource',
                );
                return obra;
              } catch (e, stackTrace) {
                developer.log(
                  '  [Dashboard] Error al mapear obra $index en obras_a_tiempo_lista: $e',
                  name: 'DashboardDataSource',
                );
                developer.log(
        ...
        developer.log(
          '  [Dashboard] obras_a_tiempo_lista mapeada: ${obrasATiempoLista.length} de ${obrasList.length} obras exitosas',
          name: 'DashboardDataSource',
        );
      } else {
        developer.log(
          '  [Dashboard] obras_a_tiempo_lista es null o no es List',
          name: 'DashboardDataSource',
        );
      }
    } catch (e, stackTrace) {
      developer.log(
        '  [Dashboard] Error general al mapear obras_a_tiempo_lista: $e',
        name: 'DashboardDataSource',
      );
    ...
    try {
      developer.log(
        '  [Dashboard] Iniciando mapeo de obras_retrasadas_lista',
        name: 'DashboardDataSource',
      );
      final tieneObrasRetrasadas = data.containsKey('obras_retrasadas_lista');
      final obrasRetrasadasValue = data['obras_retrasadas_lista'];
      developer.log(
        '  - data contiene obras_retrasadas_lista: $tieneObrasRetrasadas',
        name: 'DashboardDataSource',
      );
      developer.log(
        '  - data[obras_retrasadas_lista] es null: ${obrasRetrasadasValue == null}',
        name: 'DashboardDataSource',
      );
      if (tieneObrasRetrasadas) {
        developer.log(
          '  - data[obras_retrasadas_lista] tipo: ${obrasRetrasadasValue.runtimeType}',
          name: 'DashboardDataSource',
        );
        developer.log(
          '  - data[obras_retrasadas_lista] es List: ${obrasRetrasadasValue is List}',
          name: 'DashboardDataSource',
        );
      }
      if (obrasRetrasadasValue != null && obrasRetrasadasValue is List) {
        ...
        developer.log(
          '  [Dashboard] obras_retrasadas_lista tiene ${obrasList.length} elementos',
          name: 'DashboardDataSource',
        );
        ...
        obrasRetrasadasLista = obrasList
            ...
            .map((entry) {
              ...
              if (item is! Map<String, dynamic>) {
                developer.log(
                  '  [Dashboard] Obra $index en obras_retrasadas_lista no es Map, tipo: ${item.runtimeType}',
                  name: 'DashboardDataSource',
                );
                return null;
              }
              ...
              try {
                ...
                developer.log(
                  '  [Dashboard] Error al mapear obra $index en obras_retrasadas_lista: $e',
                  name: 'DashboardDataSource',
                );
                developer.log(
                  'Stack trace: $stackTrace',
        ...
        developer.log(
          '  [Dashboard] obras_retrasadas_lista mapeada: ${obrasRetrasadasLista.length} de ${obrasList.length} obras exitosas',
          name: 'DashboardDataSource',
        );
      } else {
        developer.log(
          '  [Dashboard] obras_retrasadas_lista es null o no es List',
          name: 'DashboardDataSource',
        );
      }
    } catch (e, stackTrace) {
      developer.log(
        '  [Dashboard] Error general al mapear obras_retrasadas_lista: $e',
        name: 'DashboardDataSource',
      );
      developer.log('Stack trace: $stackTrace', name: 'DashboardDataSource');
    ...
    try {
      developer.log(
        '  [Dashboard] Iniciando mapeo de obras_adelantadas_lista',
        name: 'DashboardDataSource',
      );
      ...
      developer.log(
        '  - data contiene obras_adelantadas_lista: $tieneObrasAdelantadas',
        name: 'DashboardDataSource',
      );
      developer.log(
        '  - data[obras_adelantadas_lista] es null: ${obrasAdelantadasValue == null}',
        name: 'DashboardDataSource',
      );
      if (tieneObrasAdelantadas) {
        developer.log(
          '  - data[obras_adelantadas_lista] tipo: ${obrasAdelantadasValue.runtimeType}',
          name: 'DashboardDataSource',
        );
        developer.log(
          '  - data[obras_adelantadas_lista] es List: ${obrasAdelantadasValue is List}',
          name: 'DashboardDataSource',
        );
      }
      if (obrasAdelantadasValue != null && obrasAdelantadasValue is List) {
        ...
        developer.log(
          '  [Dashboard] obras_adelantadas_lista tiene ${obrasList.length} elementos',
          name: 'DashboardDataSource',
        );
        ...
        obrasAdelantadasLista = obrasList
            ...
            .map((entry) {
              ...
              if (item is! Map<String, dynamic>) {
                developer.log(
                  '  [Dashboard] Obra $index en obras_adelantadas_lista no es Map, tipo: ${item.runtimeType}',
                  name: 'DashboardDataSource',
                );
                return null;
              }
              ...
              try {
                ...
                developer.log(
                  '  [Dashboard] Error al mapear obra $index en obras_adelantadas_lista: $e',
                  name: 'DashboardDataSource',
                );
                developer.log(
                  'Stack trace: $stackTrace',
        ...
        developer.log(
          '  [Dashboard] obras_adelantadas_lista mapeada: ${obrasAdelantadasLista.length} de ${obrasList.length} obras exitosas',
          name: 'DashboardDataSource',
        );
      } else {
        developer.log(
          '  [Dashboard] obras_adelantadas_lista es null o no es List',
          name: 'DashboardDataSource',
        );
      }
    } catch (e, stackTrace) {
      developer.log(
        '  [Dashboard] Error general al mapear obras_adelantadas_lista: $e',
        name: 'DashboardDataSource',
      );
      developer.log('Stack trace: $stackTrace', name: 'DashboardDataSource');
    ...
    developer.log(
      '📊 [Dashboard] Creando DashboardEntity con listas:',
      name: 'DashboardDataSource',
    );
    developer.log(
  ...
  ObraEntity _mapObraFromApi(Map<String, dynamic> data) {
    try {
      ...
      developer.log(
        '  [Dashboard] Error en _mapObraFromApi para obra ${data['id'] ?? data['_id'] ?? 'sin_id'}: $e',
        name: 'DashboardDataSource',
      );
      developer.log('Stack trace: $stackTrace', name: 'DashboardDataSource');
      developer.log(
        'Datos de la obra: ${data.keys}',
        name: 'DashboardDataSource',
      );
      rethrow;
    }
  ...
  List<TareaEntity> _mapTareasFromApi(List<dynamic> data) {
    ...
    return data
        ...
        .map((entry) {
          ...
          final item = entry.value;
          developer.log(
            'Mapeando tarea $index, tipo: ${item.runtimeType}',
            name: 'DashboardDataSource',
          );

          if (item is! Map<String, dynamic>) {
            developer.log(
              '  Tarea $index no es Map',
              name: 'DashboardDataSource',
            );
            return null;
          }
          ...
          developer.log(
            'Tarea $index keys: ${tareaData.keys}',
            name: 'DashboardDataSource',
          );
          ...
          try {
            developer.log(
              'Creando TareaEntity $index',
              name: 'DashboardDataSource',
            );
            developer.log(
              'duration valor: ${tareaData['duration']}, tipo: ${tareaData['duration']?.runtimeType}',
              name: 'DashboardDataSource',
            );
            ...
            developer.log(
              '  TareaEntity $index creada exitosamente',
              name: 'DashboardDataSource',
            );
            return tarea;
          } catch (e, stackTrace) {
            developer.log(
              '  Error al crear TareaEntity $index: $e',
              name: 'DashboardDataSource',
            );
            developer.log(
              'Stack trace: $stackTrace',
